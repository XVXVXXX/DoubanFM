...
#import "YYKit.h"
@interface DFMChannelsTableViewController (){
...
@implementation DFMChannelsTableViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    [DFMChannelInfo updateCurrentCannel:[[self.channelsList objectAtIndex:indexPath.section]objectAtIndex:indexPath.row]];
